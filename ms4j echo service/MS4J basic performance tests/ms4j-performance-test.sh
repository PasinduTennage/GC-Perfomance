...
concurrent_users=(1 500 1000) #to be changed 1 50 100 200 
heap_sizes=(100m 1g 4g) #to be changed  200m 500m 1g 2g 4g 8g
message_sizes=(50 1024) # 400 1600
garbage_collectors=(UseSerialGC UseG1GC UseParallelGC) #UseSerialGC UseParallelGC UseConcMarkSweepGC  
...
test_duration=900	 #to be changed to ___
