...
do
	...
	/home/wso2/pasindu/apache-jmeter-4.0/bin/jmeter -g  /home/wso2/pasindu/apache-jmeter-4.0/bin/results/${total_users}_users/${heap}_heap/results-measurement.jtl   -o $report_location	
