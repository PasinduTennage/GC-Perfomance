...
heap_sizes=(500m 1g 2g 4g) #change python script accordingly
...
springboot_host_user=ubuntu@192.168.32.11 # to be changed
springboot_host=192.168.32.11 #to be changed
