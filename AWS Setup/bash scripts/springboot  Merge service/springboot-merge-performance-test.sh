...
jmx_file=/home/ubuntu/pasindu/jmx/springboot_merge.jmx
...
performance_report_output_file=/home/ubuntu/pasindu/SpringBootMergePerformance.csv
        ...
        do
		    ...
		    do
			    echo "Checking service"
    			    response_code=$(curl -s -o /dev/null -w "%{http_code}" http://${springboot_host}:9000/merge?number=10)
