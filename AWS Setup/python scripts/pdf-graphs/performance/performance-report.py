    ...
    for heap in heap_sizes:
        for user in concurrent_users:
            for collector in garbage_collectors:
                ...
                if(os.path.isfile(dashboard_file_name)):
                ...
                footprint = "NA"
                avgfootprintAfterFullGC = "NA"
                avgFreedMemoryByFullGC = "NA"
                avgfootprintAfterGC = "NA"
                avgFreedMemoryByGC = "NA"
                avgPause = "NA"
                minPause = "NA"
                maxPause = "NA"
                avgGCPause = "NA"
                ...
                num_full_gc = "NA"
                num_minor_gc = "NA"
                freedMemoryPerMin = "NA"
                gcPerformance = "NA"
                fullGCPerformance = "NA"

                if (os.path.isfile(gc_log_name)):
                ...
                load_averages = "NA"
                last_one_minutes_la = "NA"
                last_five_minutes_la = "NA"
                last_fifteen_minutes_la = "NA"

                if(os.path.isfile(uptime_file_name)):
