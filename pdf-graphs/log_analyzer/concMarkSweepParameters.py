...
def getNumberOfMajorGCPauses(full_gc_times):
...
#
#
# content = readGCfile("/home/pasindu/Desktop/GCLogs/GCLogs/100m_Heap_2000_Users_UseConcMarkSweepGC_collector_GCLog.txt")
...
# print("numer_of_full_gc_pauses = " +str(getNumberOfMajorGCPauses(full_gc_times)))